@echo off
set "FAST_PARAMS=--ac-bias 1.0 --tx-bias 3 --luminance-qp-bias 20 --enable-alt-dlf 1 --qp-scale-compress-strength 3 --sharp-tx 0 --sharpness 1 --tf-strength 3"
set "FINAL_PARAMS=--ac-bias 1.0 --tx-bias 3 --luminance-qp-bias 20 --enable-alt-dlf 1 --qp-scale-compress-strength 3 --sharp-tx 0 --sharpness 1 --tf-strength 3 --complex-hvs 1 --photon-noise 400"
