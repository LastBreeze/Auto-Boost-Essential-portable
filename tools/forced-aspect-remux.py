...
# Path to mkvmerge executable (Relative to the root folder)
...
def process_files():
    ...
    print(f"Found {len(target_files)} files to check. Starting aspect ratio correction...\n")
